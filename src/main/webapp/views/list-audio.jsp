...
<head>
    ...
    <link rel="stylesheet" href="./../../resources/static/web/css/home.css">
    <link rel="stylesheet" href="./../../resources/static/web/css/audio-list.css">
            ...
            <div class="col-md-9">
                ...
                <div class="list-audio-container">
                    <div class="description">
                        <h2>Sách nói Kinh doanh – Tìm hiểu về kinh doanh – BookIt.vn. <br> Có những kiến thức từ nền tảng đến chuyên
                            sâu của kinh doanh.</h2>
                    </div>
                        ...
                        <div class="item-audio col-md-3">
                            <div class="col-inner">
                                <div class="item-content">
                                    <div class="box-img">
                                        <a href="#">
                                            <img src="./../../resources/static/images/quang-ganh-lo-di-va-vui-song.png" alt="">
                                        </a>
                                    </div>
                                    <div class="box-text">
                                        <p class="category">
